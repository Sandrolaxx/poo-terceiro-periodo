...
public class SystemMyyPlant {
    ...
    public static void showMenu() {
        ...
        while (continuar) {
            ...
            System.out.println("6. Consultar Entidades");
            System.out.println("7. Confirmar Pagamento de pedido");
    ...
    public static void showConsultationMenu() {
        ...
        while (continuar) {
            ...
            System.out.println("6. Consultar Itens");
    ...
    private static Item selectItem(){
        ...
        ItemsListContainer.printAllItems();
        int input = getNumberInput("Número do item");
